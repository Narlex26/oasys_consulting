...
class clientDAO {
    ...
    public function modifyClient($id_client,$adresse_mail_client,$nom_client,$prenom_client,$nom_entreprise_client) { // Modifie un client
        ...
        return $modifyclient->execute(array(
            "id_client" => $id_client,
            "adresse_mail_client"=>$adresse_mail_client,
            "nom_client"=>$nom_client,
            "prenom_client"=>$prenom_client,
